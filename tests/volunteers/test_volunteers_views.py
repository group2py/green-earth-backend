...
@pytest.mark.skip(
    reason="Quando faço o post para cadastrar recebo o erro ` AttributeError: "
           "'CreateVolunteers' object has no attribute 'filter_queryset'`, "
           "o erro vem da linha 30 de volunteers/api.py `queryset = self.filter_queryset(self.get_queryset())`")
@pytest.mark.django_db
